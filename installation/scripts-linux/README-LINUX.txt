...
1. Change permission on .sh files:

chmod 755 *.sh

2. Install pre-requisites. This requires ROOT permission.

sudo ./install-prereq-linux.sh

3. Register on GUROBI website and download gurobi package.
...
5. Install ADP package.
   ...
   3.a. for Linux32 use deploy-all-linux32.sh
   3.a. for Linux64 use deploy-all-linux64.sh
...
7. Set permanant environment variables. This step will modify your
